...
public class ConfigurationScreen extends OptionsSubScreen {
	...
	public ConfigurationScreen(Minecraft mc, Screen parent) {
		super(parent, mc.options, Component.translatable(MiddleTorchMod.MODID + ".configuration.title"));
	}

	@Override
	protected void addOptions() {
		list.addSmall(Button.builder(Component.translatable("controls.keybinds"), p_346358_ -> this.minecraft.setScreen(new InjectKeybindScreen(this, this.options))).build(), null);
	}

	private static class InjectKeybindScreen extends KeyBindsScreen {

		public InjectKeybindScreen(Screen parent, Options options) {
